...
public class GrassDataContainer
{
    ...
    public GraphicsBuffer commandBufLOD2;
    ...
    public void UpdateVerticesBuffer(int vertexCount, System.Array data)
    {
        planetVerticesBuffer?.Release();
     
        planetVerticesBuffer = new GraphicsBuffer(GraphicsBuffer.Target.Structured, vertexCount, sizeof(float) * 6);
        planetVerticesBuffer.SetData(data);
    }
