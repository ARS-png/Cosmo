...
public class vThirdPersonCamera : MonoBehaviour
{
    ...
    void CameraMovement()
    {
        ...
        if (CullingRayCast(desired_cPos, oldPoints, out hitInfo, distance + 0.2f, cullingLayer, UnityEngine.Color.blue))
        {
        ...
        if (CullingRayCast(current_cPos, planePoints, out hitInfo, distance, cullingLayer, UnityEngine.Color.cyan)) distance = Mathf.Clamp(cullingDistance, 0.0f, defaultDistance);
    ...
    /// <returns></returns>
    bool CullingRayCast(Vector3 from, ClipPlanePoints _to, out RaycastHit hitInfo, float distance, LayerMask cullingLayer, UnityEngine.Color color)
    {
        bool value = false;
